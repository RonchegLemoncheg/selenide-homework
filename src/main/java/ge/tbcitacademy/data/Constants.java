...
public class Constants {
    public static final String USERNAME = "Roncheg";
    ...
    public static final String COLLECTIONSTESTLINK = "https://demoqa.com/text-box";
    public static final String DROPDOWNTESTLINK = "http://the-internet.herokuapp.com/dropdown";
    public static final String PLEASESELECT = "Please select an option";
    public static final String OPTION2TEXT = "Option 2";
    public static final String CHECKBOXLINK = "http://the-internet.herokuapp.com/checkboxes";
    public static final String JSPRICE1 = "1,149";
    public static final String JSPRICE2 = "999";
    public static final String PRIORITYSUPPORT = "Priority Support ";
    public static final String INSTANCETEXT = "1 instance with 15 users";
    public static final String MOCKINGTEXT = "Mocking solution for rapid unit testing";
    public static final String ESCALATIONSTRING = "Issue escalation";
